...
export const ISO6393_TO_6391: Partial<Record<string, LangCodeISO6391>> = {
  "eng": "en",
  "cmn": "zh",
  "cmn-Hant": "zh-TW",
  "yue": "zh",
...
export const LANG_DICTIONARY_LABELS = {
  "eng": {
    pronunciation: "IPA",
...
export const LOCALE_TO_ISO6393 = {
  "en": "eng",
  "zh": "cmn",
  "zh-TW": "cmn-Hant",
  "es": "spa",
...
export const langLevel = z.enum(["beginner", "elementary", "intermediate", "upper-intermediate", "advanced", "proficiency"])
export type LangLevel = z.infer<typeof langLevel>

export const SEMANTIC_VERSION_REGEX = /^(\d+)\.(\d+)\.(\d+)(?:[-+]([0-9A-Z.-]+))?$/i
export const semanticVersionSchema = z.string().regex(SEMANTIC_VERSION_REGEX)
