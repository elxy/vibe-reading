...
export const SMART_DEFAULT_MIN_CHARACTERS_PER_NODE = 40
export const SMART_DEFAULT_MIN_WORDS_PER_NODE = 8
export const SMART_CONTENT_DETECTION_TIMEOUT_MS = 500
